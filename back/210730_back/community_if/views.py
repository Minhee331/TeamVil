...
def community_list_back(request):
    ...
    return render(request,'community_list_back.html', {'community':community})
...
def community_detail_back(request, community_id):
    ...
    return render(request, 'community_detail_back.html', {'community':community, "comments":comments, "replydict":replydict.items()})
